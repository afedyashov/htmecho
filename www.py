...
#   (see also https://stackoverflow.com/questions/37451510/python-2-7-no-console-output-in-windows-10)
...
def get_help_msg():
  ...
  --input value    explicitly specifies an input file (otherwise input is read from STDIN)
